...
interface UsdcToUsdAssimilatorInterface extends ethers.utils.Interface {
  functions: {
...
export class UsdcToUsdAssimilator extends Contract {
  ...
  interface: UsdcToUsdAssimilatorInterface;
