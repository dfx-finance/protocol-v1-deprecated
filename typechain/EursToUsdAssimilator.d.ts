...
interface EursToUsdAssimilatorInterface extends ethers.utils.Interface {
  functions: {
...
export class EursToUsdAssimilator extends Contract {
  ...
  interface: EursToUsdAssimilatorInterface;
